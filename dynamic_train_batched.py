...
from dynamic_trainer_batched import DynamicTrainerBatched
...
if __name__ == '__main__':
    ...
    start_epoch = 0
    if cfg.exp_name == "dynamic_train_batched_ni100_adv":
        start_epoch = 21
        checkpoint_path = "./snapshots/"+cfg.exp_name+"/checkpoint_20.pth"
    ...
    trainer = DynamicTrainerBatched(model=model, optimizer=optimizer,
