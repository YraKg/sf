...
if __name__ == '__main__':
    ...
    start_epoch = 0
    if cfg.exp_name == "wrn_k256_e32_ni100_adv":
        print(f"unsing preexisting checkpoint for {cfg.exp_name}")
        checkpoint_path = "./snapshots/"+cfg.exp_name+"/checkpoint_15.pth"
    ...
    for epoch in range(cfg.max_epoch):
        ...
        if cfg.smaller_train_set:
            sampler = torch.utils.data.RandomSampler(train_set,False,math.ceil(len(train_set)*0.15))
